...
### 1. AGENTS.md/CLAUDE.md (target: ≤50 lines)
Read `AGENTS.md/CLAUDE.md` and flag any content that violates these rules:
...
If AGENTS.md/CLAUDE.md exceeds 50 lines or contains removable content, edit it in place and report what was cut.
...
- Redundant with current project state (e.g., a "we use main not develop" memory after AGENTS.md/CLAUDE.md already says so)
