...
- Logic improvements present in the pragma template but not yet pulled into FinanceTracker — **Low** (`/sync-workflow` only pushes FinanceTracker → pragma; check this direction manually since no command pulls it automatically)
