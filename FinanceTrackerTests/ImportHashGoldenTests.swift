...
struct ImportHashGoldenTests {
    ...
    @Test func normalPayeeMatchesGoldenHash() {
        ...
        #expect(hash == "80b1ad9704d2e4a875c5938c4b6a2794d751b0e8c599cbccde1414b02d943998")
    }
    ...
    @Test func parsedNegativeAmountHashesItsAbsoluteValue() throws {
        ...
        #expect(parsed[0].importHash == "866e032ddda29e838a6a06fce665256971c2057b0cf80d20a4a4375d6fba365e")
    }
    ...
    @Test func wholeNumberAmountWithDecimalZerosMatchesGoldenHash() {
        ...
        #expect(hash == "1ac58c1b25b19ab84b55d04c0352549dac67fc56fa8ce3a58ce16363aa32062b")
    }
    ...
    @Test func parsedCSVRowMatchesGoldenHash() throws {
        ...
        let parsed = try CSVImportService().parse(csv: csv, mapping: mapping)
        #expect(parsed.count == 1)
        #expect(parsed[0].importHash == "80b1ad9704d2e4a875c5938c4b6a2794d751b0e8c599cbccde1414b02d943998")
    }
    ...
    @Test func fixedInstantHashFollowsTheDeviceTimeZone() {
        ...
        let expected = offset >= 1800
            ...
            : "80b1ad9704d2e4a875c5938c4b6a2794d751b0e8c599cbccde1414b02d943998"   // 2026-05-01
    ...
    @Test func importingTheSameCSVTwiceAddsNothingAndKeepsHashes() async throws {
        ...
        let firstHashes = Dictionary(uniqueKeysWithValues: firstPass.map { ($0.payee, $0.importHash) })
        #expect(firstPass.count == 3)
        #expect(firstHashes["Coffee Shop"] == "80b1ad9704d2e4a875c5938c4b6a2794d751b0e8c599cbccde1414b02d943998")
        #expect(firstHashes["ATM Withdrawal"] == "866e032ddda29e838a6a06fce665256971c2057b0cf80d20a4a4375d6fba365e")
        #expect(firstHashes["Rent"] == "1ac58c1b25b19ab84b55d04c0352549dac67fc56fa8ce3a58ce16363aa32062b")
        ...
        let secondHashes = Dictionary(uniqueKeysWithValues: secondPass.map { ($0.payee, $0.importHash) })
